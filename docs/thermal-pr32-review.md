...
| R10 assumptions/cache | Replaced obsolete method docs with fixed-geometry, units, absorption, contact, radiance, cache and output contracts. | “The supported model and conservative cache behavior are documented.” |
